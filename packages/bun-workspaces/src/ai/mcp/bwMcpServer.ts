...
bun-workspaces provided MCP server: Tools to query Bun monorepo workspace metadata 
and documentation resources for the bun-workspaces CLI and TypeScript API.
...
The tools provided can save effort understanding project structure and scripts available.
...
See the bw://docs/cli resource for the full CLI reference including all run-script options.`.replace(
  /\s+/g,
  " ",
);
