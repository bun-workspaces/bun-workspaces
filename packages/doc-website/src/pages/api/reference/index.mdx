...
Get an array of all [Workspaces](/api/reference#workspace) that have a given tag. Tags are defined in a workspace's [configuration](/config/workspace).
<SyntaxHighlighter language="typescript">
{LIST_WORKSPACES_WITH_TAG_EXAMPLE}
</SyntaxHighlighter>
...
Get a mapping of all tags to the [Workspaces](/api/reference#workspace) that have them in their respective [workspace configuration](/config/workspace).
<SyntaxHighlighter language="typescript">
{MAP_TAGS_TO_WORKSPACES_EXAMPLE}
</SyntaxHighlighter>
